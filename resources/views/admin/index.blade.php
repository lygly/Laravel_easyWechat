...
<div class="layui-layout layui-layout-admin">
        ...
        <div class="layui-main">
            ...
            <ul class="layui-nav top_menu">
                ...
                <li class="layui-nav-item" pc>
                    <a href="javascript:;">
                        <img src="{{asset('style/admin/img/face.jpg')}}" class="layui-circle" width="35" height="35">
                        <cite>请叫我马哥</cite>
                    </a>
                    <dl class="layui-nav-child">
                        <dd><a href="javascript:;" data-url="page/user/userInfo.html"><i class="iconfont icon-zhanghu" data-icon="icon-zhanghu"></i><cite>个人资料</cite></a></dd>
                        <dd><a href="javascript:;" data-url="page/user/changePwd.html"><i class="iconfont icon-shezhi1" data-icon="icon-shezhi1"></i><cite>修改密码</cite></a></dd>
                        <dd><a href="{{url('admin/quit')}}"><i class="iconfont icon-loginout"></i><cite>退出</cite></a></dd>
                    </dl>
                </li>
            </ul>
        </div>
    ...
    <div class="layui-side layui-bg-black">
        <div class="user-photo">
            <a class="img" title="我的头像" ><img src="{{asset('style/admin/img/face.jpg')}}"></a>
...
<div class="admin-header-lock" id="lock-box" style="display: none;">
    <div class="admin-header-lock-img"><img src="{{asset('style/admin/img/face.jpg')}}"/></div>
...
<script type="text/javascript" src="{{asset('style/admin/js/nav.js')}}"></script>
<script type="text/javascript" src="{{asset('style/admin/js/leftNav.js')}}"></script>
<script type="text/javascript" src="{{asset('style/admin/js/index.js')}}"></script>
    </body>
@endsection